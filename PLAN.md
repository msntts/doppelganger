...
- [x] 2-1. `skills/tune/SKILL.md` フロントマター + 候補表示・番号選択フォーマット定義
- [x] 2-2. JSON 書き込み手順（allow_patterns.json・denied_patterns.json の作成/更新）
- [x] 2-3. tune-skip.json 更新 + 自動 git commit 手順

## Phase 3: 文書化

- [x] 3-1. `CLAUDE.md` に `/tune` の位置づけ追記（`fewer-permission-prompts` との使い分け含む）
